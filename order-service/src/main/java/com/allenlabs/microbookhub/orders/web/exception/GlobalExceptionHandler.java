package com.allenlabs.microbookhub.orders.web.exception;

import com.allenlabs.microbookhub.orders.domain.InvalidOrderException;
import com.allenlabs.microbookhub.orders.domain.OrderNotFoundException;
import java.net.URI;
